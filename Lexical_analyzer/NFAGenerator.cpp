#include "include/NFAGenerator.h"

using namespace std;

NFA* NFAGenerator::generateNFA(vector<pair<string, string>> rules){
...
bool NFAGenerator::isOperator(char c){
    return c == '|' || c == '*' || c == '+' || c == '~';
}

void NFAGenerator::print_nfa(NFA* nfa){
    queue<State*> q;
