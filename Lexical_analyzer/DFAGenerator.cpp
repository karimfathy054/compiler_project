#include "include/DFAGenerator.h"

using namespace std;

std::string DFAGenerator::set_to_string(const std::set<State*> s) {
    std::string result = "";
    for (State* elem : s) {
...
DFAState* DFAGenerator::generateDFA(NFA* nfa, vector<pair<string, string>> rules, unordered_set<char> possible_inputs){
