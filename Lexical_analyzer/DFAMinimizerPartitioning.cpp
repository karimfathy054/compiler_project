#include "include/DFAMinimizerPartitioning.h"

using namespace std;

DFAMinimizerPartitioning::DFAMinimizerPartitioning(DFAState* start_state) {
    this->start_state = start_state;
    this->all_states = get_all_states(start_state);
}

DFAState* DFAMinimizerPartitioning::minimize() {
...
vector<DFAState*> DFAMinimizerPartitioning::get_all_states(DFAState* start_state) {
...
unordered_map<string, vector<DFAState*>> DFAMinimizerPartitioning::split_on_accepting_states(vector<DFAState*> all_states) {
