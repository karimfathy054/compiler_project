#include "include/DFAMinimizerMNtheorem.h"

using namespace std;

DFAMinimizerMNtheorem::DFAMinimizerMNtheorem(DFAState* start_state) {
    queue<DFAState*> q;
...
bool DFAMinimizerMNtheorem::mark_cell(DFAState* first_state , DFAState* second_state){
...
void DFAMinimizerMNtheorem::minimize(){
